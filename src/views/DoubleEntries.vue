<template>
    <div>
        <div class="d-flex align-center">
            ...
            <v-spacer />
            <v-btn-toggle v-model="only_rein" mandatory variant="tonal" density="compact">
                ...
                <template v-if="toggle === 0">
                    ...
                    >
                        ...
                        <v-list-item-title class="text-wrap text-body-1 v-row align-center">
                            <span v-if="similarity_type" class="font-weight-bold v-col-12 pb-0">{{
                                song.titel
                            }}</span>
                            <div class="v-col-1">
        ...
        <v-dialog v-if="toggle === 0" v-model="duplicates_dialog" width="700" @close="modalClose">
        ...
        <v-dialog
            ...
            @close="modalClose"
        >
            <MelodieDialog :melodie="selected_element" @close="duplicates_dialog = false" />
        </v-dialog>
    </div>
</template>
        ...
        filtered_entries() {
            ...
            for (let entry of entries) {
                ...
                for (let element of entry) {
                    if (this.toggle >= 3 && _.find(flattened_entries, { id: element.id })) {
                        exists = true;
                        break;
                ...
                _.map(this.store.files, (entry) => {
                    return _.filter(
                        ...
                        (entry2) => {
                            ...
                            return (
                                stringSimilarity.compareTwoStrings(entry.title, entry2.title) > 0.8
                            );
                        },
                    );
                }),
