    ...
    <v-container fluid class="sing-mode-container">
        ...
        <div v-if="!showSongView" class="h-100">
            <div class="d-flex align-center justify-space-between mb-8">
                ...
                >
                    <v-icon start>{{ isSelectionLinked ? 'mdi-link' : 'mdi-link-off' }}</v-icon>
            ...
            <div v-if="isSelectionLinked" class="mb-6">
                ...
                <div v-if="selectedLinkedSong && availableLinkedMediaFiles.length > 0" class="mt-6">
                    ...
                    <v-alert v-if="!selectedMediaFile" type="info" variant="tonal" class="mt-3">
                        Bitte wählen Sie eine Datei aus
                    </v-alert>
                </div>

                <v-alert
                    v-else-if="selectedLinkedSong && availableLinkedMediaFiles.length === 0"
                    type="warning"
                    variant="tonal"
                    class="mt-4"
                >
                                        ...
                                        >
                                            <template #append>
                                                <v-chip size="small" color="primary">
                                                    {{ item?.raw?.strophenEinzeln?.length || 0 }}
                                                    Strophen
                                                </v-chip>
                                            </template>
                                            <span style="font-size: 0.8rem">{{
