<template>
    ...
    <UploadProgress
        ...
        :category-gesangbuchlied-mapping="successfully_created.category_gesangbuchlied_mapping"
    ...
    methods: {
        ...
        async delete_created_stuff() {
            ...
            if (this.successfully_created.category_gesangbuchlied_mapping.length !== 0) {
                await axios
                    .delete(`${import.meta.env.VITE_BACKEND_URL}/items/gesangbuchlied_kategorie`, {
                        data: [
                            _.map(this.successfully_created.category_gesangbuchlied_mapping, 'id'),
                        ],
                    })
