<template>
    ...
    <div class="text-body-1">
        Wähle ein Gesangbuchlied aus, bei welchem du Textvorschläge oder neue Melodie Dateien
        hochladen möchtest.
    </div>
                ...
                <div v-if="selected_song !== null">
                    <div v-if="selected_song.status === 'accepted'">
                        ...
                        >
                            ...
                            Eine Aktualisierung der Noten oder des Textes ist deshalb nicht mehr
                            möglich.
                        </v-alert>
                    </div>
                    <div v-else>
