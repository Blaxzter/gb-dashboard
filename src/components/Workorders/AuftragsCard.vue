<template>
  <v-card class="mb-4" :class="`${arbeitskreis_name_to_css(auftrag.arbeitskreis_name)}-bg`">
    ...
    <template v-slot:text>
      ...
      <v-card
        ...
        :class="`${arbeitskreis_name_to_css(auftrag.arbeitskreis_name)}-bg-dark`"
        class="mb-3 hover_card">
        <template v-slot:title>
      ...
      <v-card v-if="auftrag.melodie" :class="`${arbeitskreis_name_to_css(auftrag.arbeitskreis_name)}-bg-dark`" class="mb-3" @click="melodie_dialog = true">
        <template v-slot:title>
          <div class="d-flex align-center mb-1 text-subtitle-1">
      ...
      <v-card v-if="auftrag.anmerkung" :class="`${arbeitskreis_name_to_css(auftrag.arbeitskreis_name)}-bg-dark`" >
        <template v-slot:title>
          <div class="d-flex align-center mb-1 text-subtitle-1" @click="text_dialog = true">
  ...
  <v-dialog v-model="text_dialog" width="700">
    <TextDialog :text="auftrag.text" />
  </v-dialog>
  <v-dialog v-model="melodie_dialog" width="700">
    <MelodieDialog :melodie="auftrag.melodie" />
  </v-dialog>
</template>
