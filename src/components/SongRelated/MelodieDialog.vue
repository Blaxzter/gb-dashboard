<template>
    <v-card class="pa-3">
        ...
        <v-card-text class="px-8">
            ...
            <div v-if="melodie?.auftrag?.length" class="text-subtitle-1 font-weight-medium">
                Aufträge:
            </div>
            <div v-if="melodie?.auftrag?.length">
                <div v-for="(auftrag, index) in melodie?.auftrag" :key="index" class="mb-3">
            ...
            <div v-if="melodie?.authors?.length" class="text-subtitle-1 font-weight-medium">
                Autoren
            </div>
            <div
    ...
    <v-dialog v-model="noten_dialog" style="height: 100vh; width: 100vw">
        <div class="position-relative" style="overflow: scroll">
            ...
            ></v-btn>
            <vue-pdf-embed v-if="selected_file" :source="getPdfUrl(selected_file.id)" :page="1" />
        </div>
    </v-dialog>
</template>
