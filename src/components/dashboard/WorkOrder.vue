<template>
    <div class="text-h5">{{ filtered_auftraege.length }} Arbeitsaufträge der Arbeitskreise</div>
    <div class="mt-3">
...
export default {
    ...
    computed: {
        ...
        work_orders_data_list() {
            let work_order_data = _.countBy(this.filtered_auftraege, 'arbeitskreis_name');
            return _.filter(
